...
<html lang="en">
  <head>
    ...
    <link href="http://localhost:8080/code/css/signin.css" rel="stylesheet">
  </head>


  
  <body class="text-center">
    <form class="form-signin sg" method="POST" action="http://localhost:8080/code/users/login">
      ...
      <a href="http://localhost:8080/code/re_password/index" class="btn btn-lg btn-primary btn-block" >
        Forgot password</a>
      <a href="http://localhost:8080/code/users/registration_show" class="btn btn-lg btn-primary btn-block" >
        Create an account</a>
    ...
    <script type="text/javascript" src="http://localhost:8080/code/js/signin.js" ></script>
