...
<html lang="en">
  ...
  <header class="blog-header py-3">
    <div class="row flex-nowrap justify-content-between align-items-center">
      ...
      <a class="btn btn-sm btn-outline-secondary" href="http://localhost:8080/code/users/profile">Back</a>
      </div>
    ...
    <div class="text-center">
        <form class="form-signin sg" action="http://localhost:8080/code/sell/sell_item" method="POST"> 
