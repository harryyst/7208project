...
<head>
    ...
    <link rel="stylesheet" href="http://localhost:8080/code/css/style.css" type="text/css" />
</head>
...
<body>
    <header class="blog-header py-3">
        ...
        <div class="row flex-nowrap justify-content-between align-items-center ml-3">
            ...
            <div class="col">
                <a class="blog-header-logo text-dark float-left" href="http://localhost:8080/code/home/index">Shopping</a>
            </div>


            <form class="form-inline my-2 my-md-0 hide-submit" method="POST" action="http://localhost:8080/code/home/search">
            ...
            <div class="col-3 d-flex align-items-center">
                ...
                if (isset($_SESSION["email"])) {
                  ...
                  echo '<a class="btn btn-sm btn-outline-secondary" href="http://localhost:8080/code/users">Login/Register</a>';
                }
                ?>
            </div>
