...
<html lang="en">
  ...
  <header class="blog-header py-3">
    <div class="row flex-nowrap justify-content-between align-items-center">
      ...
      <a class="btn btn-sm btn-outline-secondary" href="https://infs3202-4d8d4229.uqcloud.net/code/users/profile">Back</a>
      </div>
      <div class="col-4 text-center">
        <a class="blog-header-logo text-dark" href="https://infs3202-4d8d4229.uqcloud.net/code/code/home/index">Shop</a>
      </div>
    ...
    <div class="text-center">
        <p>Successfully reset</p>   
        <a href="https://infs3202-4d8d4229.uqcloud.net/code/home/index">Back</a>
        </div>
        <hr>
