...
<html lang="en">
 ...
 <head>  
  ...
  <body class="text-center">
    ...
    <form class="form-signin sg" action="https://infs3202-4d8d4229.uqcloud.net/code/users/registration" method="POST"> 
 ...
 $(document).ready(function(){
  $('#username').change(function(){
   ...
   if(username != ''){
    $.ajax({
     url: "https://infs3202-4d8d4229.uqcloud.net/code/users/checkUsername",
     method: "POST",
